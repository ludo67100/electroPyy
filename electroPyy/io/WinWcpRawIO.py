...
import electroPyy.io.BaseRawIO as Base
...
class WinWcpRawIO(Base):
    ...
    def _parse_header(self):
        ...
        sig_channels = np.array(sig_channels, dtype=Base._signal_channel_dtype)

        # No events
        event_channels = []
        event_channels = np.array(event_channels, dtype=Base._event_channel_dtype)

        # No spikes
        unit_channels = []
        unit_channels = np.array(unit_channels, dtype=Base._unit_channel_dtype)
